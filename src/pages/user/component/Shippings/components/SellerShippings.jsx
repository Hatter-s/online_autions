...
const SellerShippings = (props) => {
  const navigate = useNavigate();
  const sellerShippings = useMemo(() => props.shippings, [props.shippings]);

  if (sellerShippings.length === 0) {
    return (
      <div className="my-4 sellerShippings">
