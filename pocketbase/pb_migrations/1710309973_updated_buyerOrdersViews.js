...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("tnc4nldp")

  // remove
  collection.schema.removeField("0w5nbvmj")

  // remove
  collection.schema.removeField("eafpo9ji")

  // remove
  collection.schema.removeField("yjwzcdqd")

  // remove
  collection.schema.removeField("xfmu5hwf")

  // remove
  collection.schema.removeField("asfbsjbp")

  // remove
  collection.schema.removeField("6y9lzowp")

  // remove
  collection.schema.removeField("dyxaevrd")

  // remove
  collection.schema.removeField("3qhylbc1")
