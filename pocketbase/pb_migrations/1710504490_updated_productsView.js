...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("vjriofsy")

  // remove
  collection.schema.removeField("78wexeq3")
  ...
  // remove
  collection.schema.removeField("smix2evu")

  // remove
  collection.schema.removeField("sflwil6q")

  // remove
  collection.schema.removeField("l9mclelv")

  // remove
  collection.schema.removeField("lqflsfky")

  // remove
  collection.schema.removeField("wkl9fkng")

  // remove
  collection.schema.removeField("ad296olu")

  // remove
  collection.schema.removeField("qxm6zrj2")

  // remove
  collection.schema.removeField("crywnenx")

  // remove
  collection.schema.removeField("kspb9dcj")

  // remove
  collection.schema.removeField("872fdfv7")

  // remove
  collection.schema.removeField("okfig5al")

  // remove
  collection.schema.removeField("kkwnfmlx")
